...
Yes! And I will tell it to you: advanced program analysis.
This is outside of the scope of this module, but if you are brave and interested, you can use one of experiment program analysis tools out there to try to _automate_ the solution of these challenges.
One such tool is [angr](angr.io), which has some [examples](https://docs.angr.io/docs/examples.html) of its usage and [installs](https://docs.angr.io/INSTALL.html) through a docker container.
As a heads up, this is not a simple tool to use.

You may also have luck with gdb scripting.
